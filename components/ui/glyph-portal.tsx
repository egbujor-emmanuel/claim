...
function interior(context: CanvasRenderingContext2D, char: string, font: string): Omit<Ink, "index"> | null {
  ...
  for (let y = 0; y < height; y++) {
    ...
    for (let x = 0; x < width; x++) {
      // Non-null assertions: every index here is provably in bounds, and this
      // is the inner loop of a per-pixel scan. Our tsconfig sets
      // noUncheckedIndexedAccess, which the upstream component does not assume.
